...
export function WhatWeDoSection() {
  return (
    <section className="relative z-10 bg-white rounded-t-3xl flex justify-center px-[24px] py-[100px]">
      <div className="w-full max-w-[1090px] flex flex-col gap-[22px] items-start">
        <motion.p
          initial={{ opacity: 0, y: 30 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.7 }}
          className="font-['Figtree',sans-serif] font-light leading-[48px] tracking-[-0.1px] max-w-[1090px] text-[#333] text-[24px] md:text-[32px]"
        >
