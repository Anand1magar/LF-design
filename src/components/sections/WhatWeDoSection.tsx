...
export function WhatWeDoSection() {
  return (
    <section className="relative z-10 bg-white rounded-t-3xl flex justify-center px-6 py-[100px]">
      <div className="w-full max-w-[1190px] flex flex-col gap-6 items-start">
        <motion.p
          ...
          className=" font-light leading-[48px] tracking-[-0.1px] max-w-[1190px] text-(--color-ink-600) text-2xl md:text-display-sm"
        >
