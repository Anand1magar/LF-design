...
export function PortfolioShowcase() {
  ...
  const handleSave = useCallback(async () => {
    ...
    // Write DEFAULTS directly to source via Next.js API route
    try {
    ...
    <section ref={sectionRef} className="bg-(--bg-dark-alt) text-white relative">
        ...
        <div className="w-[35%] sticky top-0 h-screen flex flex-col justify-between px-12 xl:px-20 py-16 xl:py-20 z-10">
          ...
          <div className="flex flex-col gap-[8px] pb-[33px] border-b border-(--color-ink-550)">
            <motion.p
              ...
              className=" font-light text-5xl leading-[48px] tracking-[-1.44px] text-white"
            >
              Portfolio
            </motion.p>
          ...
          <div className="flex-1 flex items-end pb-10">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className=" font-light text-white/50 text-xl leading-[1.7] max-w-[380px]"
              >
                {active.description}
              </motion.p>
            </AnimatePresence>
      ...
      <div className="lg:hidden px-5 py-16">
        <motion.p
          ...
          viewport={{ once: true }}
          transition={{ duration: 0.6 }}
          className=" text-white/40 text-sm tracking-wide mb-2"
        >
          Portfolio
        </motion.p>
        <motion.h2
          ...
          className=" font-light text-3xl md:text-display-lg leading-tight tracking-tight text-white mb-12"
        >
          Selected Projects
        </motion.h2>
        ...
        <div className="flex flex-col gap-16">
          {showcaseItems.map((item, i) => (
            ...
            >
              ...
              {/* Text */}
              <h3 className=" font-light text-white tracking-tight text-display-sm">
                {item.name}
              </h3>
              <p className=" font-light text-white/45 leading-[1.65] mt-3 max-w-[440px] text-sm">
                {item.description}
              </p>
