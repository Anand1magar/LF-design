function Frame5() {
  return (
    <div className="content-stretch flex flex-col font-normal h-[83px] items-start relative shrink-0 text-[#1a1a1a] w-full whitespace-pre-wrap">
      <p className="font-['Figtree:Regular',sans-serif] leading-[47.693px] relative shrink-0 text-[32px] tracking-[-1px] w-full">Visual Branding</p>
...
function Component() {
  return <div className="aspect-[285/331.23828125] bg-[#dbdbdb] rounded-[13.001px] shrink-0 w-full" data-name="Component 5" />;
}
