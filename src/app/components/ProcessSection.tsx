...
export function ProcessSection() {
  return (
    <section className="bg-white px-5 py-16 sm:px-8 sm:py-20 md:px-[64px] md:py-[128px]">
      ...
      <div className="max-w-[1190px] mx-auto">
        <motion.div
          ...
          className="mb-16"
        >
          <h2 className="font-['Figtree',sans-serif] font-light text-[48px] leading-tight tracking-tight">
      ...
      {/* Process Steps - wider 1400px container */}
