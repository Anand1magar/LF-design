...
function TestimonialCardGrid() {
  return (
    <div className="flex flex-col gap-[20px] lg:gap-4">
      ...
      <div className="flex flex-col lg:flex-row gap-[20px] lg:gap-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-[12px] overflow-hidden relative flex flex-col gap-[30px] p-[24px] lg:p-10 lg:h-[385px] lg:flex-1"
        >
          {/* Quote */}
      ...
      <div className="flex flex-col lg:flex-row gap-[20px] lg:gap-4">
        ...
        <motion.div
          ...
          className="bg-white rounded-[12px] overflow-hidden relative flex flex-col gap-[30px] p-[24px] lg:p-10 lg:h-[385px] lg:flex-1 order-2 lg:order-1"
        >
          {/* Quote */}
          <p className="font-['Figtree',sans-serif] font-light text-[#121212] text-[19px] lg:text-[19px] leading-[28.74px]">
            "It would have taken months to build the product team that we
